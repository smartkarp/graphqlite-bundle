    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if (isset($config['namespace']['controllers'])) {
            ...
            $namespaceController = array_map(
                static fn($namespace): string => rtrim($namespace, '\\').'\\',
                $controllers
            );
        } else {
            $namespaceController = [];
        ...
        $container->setParameter(
            'graphqlite.security.maximum_query_complexity',
            $config['security']['maximum_query_complexity'] ?? null
        );
        $container->setParameter(
            'graphqlite.security.maximum_query_depth',
            $config['security']['maximum_query_depth'] ?? null
        );
